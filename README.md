...
The actual project is documented in the [Project](Project.md) file, with
the corresponding Rmarkdown [Project.Rmd](Project.Rmd) file for
reference. The question and guide for the project is [given
