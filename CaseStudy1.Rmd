...
```
This is just to check the duration ranges we are dealing with. Max time is 2483235 sec which is nearly 28 days. It is a docked bike, which someone likely forgot to return to dock. Any hiretime greater than 24 hrs seems to be docked bikes, since there is no person to enforce the return of the bikes.
